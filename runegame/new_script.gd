...
var card_front_texture = preload("res://Artwork/CardFront.png")
...
func display_card(card_index: int, order: int) -> void:
	...
	if card_front_sprite:
		print("CardFrontSprite found")
		print("CardFrontSprite visible:", card_front_sprite.visible)
		print("CardFrontSprite position:", card_front_sprite.position)
		print("CardFrontSprite texture:", card_front_sprite.texture)
	else:
		print("Error: CardFrontSprite is not found in the card scene")
	
	# Set textures
	card_front_sprite.texture = card_front_texture
	...
	card_front_sprite.z_index = 2  # Ensure CardFrontSprite is behind
